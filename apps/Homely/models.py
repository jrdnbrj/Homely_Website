...
class Producto(models.Model):
    ...
    numero_compras = models.IntegerField(default = 0, blank = True, null=True)
    precio = models.DecimalField(decimal_places = 2, max_digits = 5)
    reseñas = models.ManyToManyField(Reseña, related_name = "reseña", blank = True)

    def __str__(self):
        return str(self.negocio) + " - " + self.nombre
...
class Pedido(models.Model):
    ...
    def __str__(self):
        return str(self.fecha) + " - " + str(self.usuario) + " - " + str(self.valor)